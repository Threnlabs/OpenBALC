...
async function ensureUserPrimaryWorkspace(userId, displayName) {
...
export function useGetCreditsBalance(options) {
    return useQuery({
        ...
        queryFn: async () => {
            ...
            const userId = await getDbUserId();
            if (!userId)
                return { balance: 0, usedThisMonth: 0 };
...
export function useGetDashboardSummary(options) {
    return useQuery({
        ...
        queryFn: async () => {
            ...
            const userId = await getDbUserId();
            if (!userId)
                return { moduleCount: 0, conversationCount: 0, credits: 0, weeklyQuestions: 0, recentModules: [], recentConversations: [] };
...
export function useListWorkspaces(options) {
    return useQuery({
...
export function useSwitchWorkspace(options) {
...
export function useCreateExpertTicket(options) {
    return useMutation({
        mutationFn: async ({ data }) => {
            if (!hasSupabase) {
                const queue = getStorageItem("openbalc_expert_queue", DEFAULT_EXPERT_QUEUE);
            ...
            if (!orgId)
                throw new Error("User must belong to an organization to file an expert ticket.");
...
export function useUpdateOrgMember(options) {
    return useMutation({
...
export function useRemoveOrgMember(options) {
    return useMutation({
...
export function useGetAIModels(options) {
    return useQuery({
...
export function useUpdateAIModel(options) {
    return useMutation({
        mutationFn: async ({ id, data }) => {
...
export function useGetAIServices(options) {
    return useQuery({
...
export function useUpdateAIServiceModel(options) {
    return useMutation({
        mutationFn: async ({ id, activeModelId }) => {
...
export function useGetAILogs(options) {
    return useQuery({
...
export function useClearAILogs(options) {
    return useMutation({
        mutationFn: async () => {
...
export function useUpdateUserCredits(options) {
    return useMutation({
...
export const getGetArtifactQueryKey = (id) => ["getArtifact", id];
...
export function useListArtifacts(options) {
    return useQuery({
...
export function useGetArtifact(id, options) {
    return useQuery({
        queryKey: getGetArtifactQueryKey(id),
        queryFn: async () => {
            if (!hasSupabase) {
                const list = getStorageItem("openbalc_artifacts", MOCK_ARTIFACTS);
                const found = list.find((a) => a.id === id || String(a.id) === String(id));
                if (!found)
...
export function useCreateArtifact(options) {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async ({ data }) => {
            if (!hasSupabase) {
                const list = getStorageItem("openbalc_artifacts", MOCK_ARTIFACTS);
                const newId = list.length > 0 ? Math.max(...list.map((a) => typeof a.id === "number" ? a.id : 0)) + 1 : 1;
                const newArtifact = {
                    id: newId,
...
export function useUpdateArtifact(options) {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async ({ id, data }) => {
            if (!hasSupabase) {
                const list = getStorageItem("openbalc_artifacts", MOCK_ARTIFACTS);
                const idx = list.findIndex((a) => a.id === id || String(a.id) === String(id));
                if (idx !== -1) {
...
export function useDeleteArtifact(options) {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async ({ id }) => {
            if (!hasSupabase) {
                const list = getStorageItem("openbalc_artifacts", MOCK_ARTIFACTS);
                const filtered = list.filter((a) => a.id !== id && String(a.id) !== String(id));
